# NerfHack
- [NerfHack](#nerfhack)
  - [Big changes from NetHack 3.6/3.7](#big-changes-from-nethack-3637)
  ...
  - [RESOURCE CONTROL(NERFS) AND MECHANIC CHANGES](#resource-controlnerfs-and-mechanic-changes)
    - [Slow Luck timeouts (modified)](#slow-luck-timeouts-modified)
    - [ENDGAME CHANGES](#endgame-changes)
    - [FINITE ALTAR NERFS](#finite-altar-nerfs)
    ...
    - [INTRINSIC CHANGES](#intrinsic-changes)
    ...
    - [ITEM EROSION AND DESTRUCTION](#item-erosion-and-destruction)
      - [Refactor, unify, and nerf item destruction](#refactor-unify-and-nerf-item-destruction)
  ...
  - [MONSTER CHANGES](#monster-changes)
    ...
    - [MONSTER BEHAVIOR](#monster-behavior)
      ...
      - [Ported jumping behavior](#ported-jumping-behavior)
  ...
  - [ITEM CHANGES](#item-changes)
    - [CURSED ITEM EFFECTS](#cursed-item-effects)
    ...
    - [Unicorn horns](#unicorn-horns)
      - [Unicorn horns now reduce the timeouts of most afflications instead of outright curing.](#unicorn-horns-now-reduce-the-timeouts-of-most-afflications-instead-of-outright-curing)
...
* gauntlets of fumbling grant -9 to-hit penalty while using bows (Evil)
